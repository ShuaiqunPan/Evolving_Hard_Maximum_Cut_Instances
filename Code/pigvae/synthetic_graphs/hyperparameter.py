...
def add_arguments(parser):
    ...
    parser.add_argument("--eval_freq", default=0.1, type=float) # batch: 32 (1875-60000, 19-600, 282-6000), batch: 64 (94-6000), # 4-gpu: batch(4)-188, batch(32)-47, batch(64)-24
    ...
    # The parameters for 20-node graphs
    # GRAPH ENCODER
    ...
    # The parameters for 100-node graphs
    # # GRAPH ENCODER
    # parser.add_argument("--emb_dim", default=64, type=int)
    # parser.add_argument("--graph_encoder_hidden_dim", default=256, type=int)
    # parser.add_argument("--graph_encoder_k_dim", default=64, type=int)
    # parser.add_argument("--graph_encoder_v_dim", default=64, type=int)
    # parser.add_argument("--graph_encoder_num_heads", default=4, type=int)
    # parser.add_argument("--graph_encoder_ppf_hidden_dim", default=512, type=int)
    ...
    # parser.add_argument("--graph_decoder_k_dim", default=64, type=int)
    # parser.add_argument("--graph_decoder_v_dim", default=64, type=int)
    # parser.add_argument("--graph_decoder_num_heads", default=4, type=int)
    # parser.add_argument("--graph_decoder_ppf_hidden_dim", default=512, type=int)
    ...
    parser.add_argument("--graph_family", default="all", type=str)
    parser.add_argument("--n_min", default=20, type=int)
